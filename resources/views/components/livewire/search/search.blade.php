<div class="container" id="searchbar">
    <form class="row" method="GET" wire:submit.prevent="search">
        ...
        <div class="col-12 d-flex flex-row justify-content-end">
            <button class="btn btn-link" type="button" id="search-place" data-bs-toggle="modal" data-bs-target="#searchQueryModal">
        ...
        <div class="modal fade" id="searchQueryModal" tabindex="-1" aria-labelledby="searchQueryModalLabel" style="display: none;" aria-hidden="true">
