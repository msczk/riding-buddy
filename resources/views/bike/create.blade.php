            ...
            <form id="profile_edit_form" method="POST" action="{{ route('bike.create') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input required name="cylinder" value="{{ old('cylinder') ?? 50 }}" type="number" min="1" class="form-control @error('cylinder') is-invalid @enderror" id="cylinder">
                ...
                <div class="mb-3">
                    ...
                    <input name="year" value="{{ old('year') }}" type="number" class="form-control @error('year') is-invalid @enderror" id="year">
                    @error('year')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
